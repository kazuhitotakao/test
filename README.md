...
　　　〇店舗画像のアプロードと店舗情報の登録が可能（※１店舗代表者につき１店舗のみの登録としています。）  
　　　〇時間帯ごとの予約枠の上限設定（店側でこのアプリから予約できる枠の指定ができます。）  
　　　〇予約時の時間間隔の設定（店側で予約の時間間隔を何分毎の間隔にするかの指定ができます。）  
　　　〇評価★の数やコメント内容閲覧可能（店舗代表者のみ※評価投稿があったら表示するようにしています。）  
　　　〇ＱＲコードリーダー起動可能  
#### 　・店舗代表者設定管理画面（管理者用）  
#### 　・メール送信機能（店舗代表者・管理者）  
#### 　・リマインダー機能  
